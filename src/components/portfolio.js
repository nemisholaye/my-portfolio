...
const portfolio = () => {
  return (
    <section id="portfolio">
      ...
      <span className="portDesc">I pay attention to details to give you an excellent job jdjfklfknj fnfjngtngkngtn jskbjbx kw wkbwbkkxb dknjek ehrfkek ejnkjrfb fhdewihw hwgiudhiue edgiuweh tjrgntjnjtgnjktr trjnnvjknkngtkjnkgmk jtrgnjkgtrnkrnmkgr </span>
